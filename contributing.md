...
hi！很高兴你有兴趣为 OP UI 做贡献, 从创建这个库开始 OP UI 的愿景一直都只有一个，那就是成为你前端的最后一个 React UI 框架，用于服务于成千上万的优质 Web 应用。

言归正传，OP UI 遵守 Android 和 IOS 设计规范，巧妙的进行令人惊叹的样式设计，合理的组件分类，提供丰富的常用功能，以及顶级的开发者体验。所以一些哲学和项目结构所也许和你熟悉的不一样，在提交您的贡献之前，请务必花点时间阅读以下指南:
